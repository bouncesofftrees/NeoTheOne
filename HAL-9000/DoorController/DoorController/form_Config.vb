...
#End Region
    ...
    Public Sub InitializeForm(ByRef CommSys_in As StaXCommsLib.StaxCommunications)
        ...
        Me.TextBox_ParticipantID.Text = ParticipantID
        txtLatitudeDD.Text = LatitudeDD.ToString
        txtLongitudeDD.Text = LongitudeDD.ToString
    End Sub
    ...
    Private Sub SaveSettings(ByRef SaveWasSuccessful As Boolean)
        ...
        Try
            ParticipantID = Me.TextBox_ParticipantID.Text
